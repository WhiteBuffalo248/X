...
StringConcatTaskThread_<void(*)(const std::string &)> * p_stringConcatTaskThread_;
...
static void GuiAddLogMessageAsync(_In_z_ const char* msg)
{
	...
	p_stringConcatTaskThread_ = &task;
...
*/
void dputs(_In_z_ const char* Text, bool bSynchronize)
{
	...
	else
	{
		...
		{
			GuiAddLogMessage(TranslatedText);
		}
	}		
}