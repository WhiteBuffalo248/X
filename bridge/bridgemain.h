...
#define DBG_VERSION 25
	...
	//...
	BRIDGE_IMPEXP const wchar_t* BridgeTest();
	//...
	BRIDGE_IMPEXP const wchar_t* BridgeEnd();
...
BRIDGE_IMPEXP bool DbgCmdExec(const char* cmd);/// <summary>
