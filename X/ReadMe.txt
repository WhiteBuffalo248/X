================================================================================
    MICROSOFT 基础类库 : X 项目概述
===============================================================================

应用程序向导已为您创建了此 X 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 X 应用程序的每个文件的内容。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 X.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
